...
const getApiComponentes = async () => {
    ...
    const allComponentes = [...infoGabinetes, ...infoMemoriasRam, ...infoPlacasGraficas, ...infoMonitores, ...infoDiscos, ...infoFuentesDePoder, ...infoProcesadores, ...infoPlacasBase, ...infoRefrigerantes, ...infoPerifericos];
